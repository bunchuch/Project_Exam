...
<section className="bg-[#142544] md:mt-10 dark:bg-gray-900">
    <div className="container flex flex-col px-6 py-4 mx-auto space-y-6 lg:h-[32rem] lg:py-10 lg:flex-row ">
        ...
        <div className="flex items-center justify-center w-full h-96 lg:w-1/2 ">
            ...
            <img className="object-cover= w-full h-full mx-auto translate-x-2 -translate-y-2 transition duration-500 ease-in-in hover:scale-200 transform hover:-translate-y-3 lg:max-w-2xl" 
