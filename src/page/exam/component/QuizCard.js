...
import {  BiBook, BiCommentDots, BiEditAlt,  BiFontColor, BiHeadphone, BiMouse, BiQuestionMark} from "react-icons/bi"
  ...
  if (names === 'READING')   { 
    ...
    <div className={`md:px-6 px-4 py-4  md:py-6  2xl:space-y-4 
     ${renderColorBg(title)} rounded-lg border-y-[1px] border-x-[1px] 
      hover:bg-gradient-to-b hover:from-gray-600 hover:to-gray-800 hover:z-10 `}>
        <div className={ "rounded-full pb-1.5 mt-3  "}>
           ...
           <div className="">
              <h1 className="md:text-xl text-center mt-4 tracking-wider md:font-semibold font-roboto
         t">{title}</h1>
       </div>
        </div>
       <div className="divide-x flex justify-center mt-4 text-slate-900">
       <div className="bg-gradient-to-tr from-emerald-500  to-emerald-600  text-slate-900 text-center px-2 rounded-l-full flex">
