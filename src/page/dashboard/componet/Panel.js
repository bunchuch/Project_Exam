...
export default function Panel () {
    ...
    const noramlStyle = "w-full h-full text-gray-600 relative   bg-white px-4  "
    const panelStyle =  "mx-auto mt-[2rem]  rounded-xl relative p-5 mx-auto"
    return <div className={`font-ubuntu ${respone ? "basis-[95%] 2xl:basis-[100rem] " 
    : "basis-[95%] 2xl:basis-[100%] "}` + noramlStyle} >
